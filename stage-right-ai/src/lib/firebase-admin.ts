...
if (!defaultApp) {
    ...
    if (serviceAccountKey) {
        console.log(`[Firebase Admin] Found FIREBASE_SERVICE_ACCOUNT_KEY (Length: ${serviceAccountKey.length})`);
        try {
        ...
        console.warn("[Firebase Admin] FIREBASE_SERVICE_ACCOUNT_KEY is not defined. Firebase Admin not initialized.");
    }
} else {
